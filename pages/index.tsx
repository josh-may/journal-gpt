...
export default function Home() {
  ...
  const listItems: string[] = ['Item 1', 'Item 2', 'Item 3'];

  return (
    <>
      <Layout>
        <section className="container max-w-xl mx-auto pt-4 pb-6 md:pt-8 md:pb-10 lg:pt-10 lg:pb-16 text-white">
          <div className="mx-auto flex flex-col gap-4">
            <h1 className="text-3xl mb-3 font-bold tracking-tight text-white">
              Turn Your Obsidian Notes into a Chatbot &nbsp;🙌
            </h1>
            ...
            <div className="flex w-full max-w-xl items-center space-x-2">
              <input
                ...
                type="text"
                placeholder="What was I thinking about this month?"
                value={query}
            ...
            {!loading && answer.length > 0 && (
              <>
                <div className="rounded-md border-neutral-300 border p-5 mt-4">
                  ...
                  <p className="leading-normal text-slate-700 dark:text-slate-50 sm:leading-7 mt-3">
                    {answer}
                  </p>
                </div>
              </>
